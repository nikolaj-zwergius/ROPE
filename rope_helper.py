if __name__ == "__main__":
    ...
    function_help ={
        "fold":"functions as batch_revolvr from ROAD takes [<file1> ...] [runs_per_file] [max_workers],\n use the batch_revolvr.py or batch_revolvr.bat of ROPE for dircict call\n",
        ...
        "dragon":"functions as dragon.pl from Cody geary's github fork of the ROAD software [<file1> ...] [runs_per_file] [max_workers]\n num of files * runs_per_file must equal or less then max workers,\nuse the dragon.py or dragon.bat of ROPE for dircict call\n"
    }
